...
public class CollectionUtils {
     ...
     *            map 值元素类型
     */
    public static <T, K, V> Map<K, V> toMap(Collection<T> collection, Function<? super T, ? extends K> keyFunction,
    ...
    public static <K, V, C> Map<K, C> convertMapValue(Map<K, V> map, BiFunction<K, V, C> valueFunction,
        ...
        return map.entrySet().stream().collect(
            Collectors.toMap(Map.Entry::getKey, e -> valueFunction.apply(e.getKey(), e.getValue()), mergeFunction));
    }
