...
import org.example.acmwwh.common.util.CollectionUtils;
...
class CollectionUtilsTest {
    ...
    public Collection<OrderItem> coll =
        new HashSet<>(Arrays.asList(new OrderItem(1L, "1", 100.0), new OrderItem(2L, "2", 200.0)));
